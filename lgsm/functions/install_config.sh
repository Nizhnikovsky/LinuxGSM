...
fn_fetch_default_config(){
	...
	echo -e "================================="
	echo -e "default configs from https://github.com/Nizhnikovsky/LinuxGSMFork"
	fn_sleep_time
	mkdir -p "${lgsmdir}/config-default/config-game"
	githuburl="https://${gittoken}@raw.githubusercontent.com/Nizhnikovsky/LinuxGSMFork/minecraft_vanilla"
